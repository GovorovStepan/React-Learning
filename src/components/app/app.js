...
export default class App extends Component {
        constructor(props){
                ...
                this.state={
                        data : [
                        {label: 'Собираюсь изучать React', important: false, like:false, id:1},
                        {label: 'Изучаю React', important: false, like:false, id:2},
                        {label: 'Все еще изучаю React...', important: false, like:false,  id:3}],
                        term:'',
                        filter:'all'
                };
